...
module FSharpFunctionSandbox =
    ...
    module VolumeConversion =
        ...
        let pecksUkToBushelsUk (gal: decimal<peck>) = gal / pecksPerBushelUk
        let bushelUkToPecksUk (bh: decimal<bushel>) = bh * pecksPerBushelUk
        let bushelsToQuartersUk (bh: decimal<bushel>) = bh / bushelsPerQuarterUk
        ...
        let millilitersToMinimsUs = millilitersToTeaspoons >> teaspoonsUsToMinimsUs
        ...
        let millilitersToHogshead = millilitersToBarrels >> barrelsToHogshead
        ...
        let millilitersToPecksUk = millilitersToGallonsUk >> gallonsUkToPecksUk
        ...
        let millilitersToBushelsUk = millilitersToPecksUk >> pecksUkToBushelsUk
        let millilitersToQuartersUk = millilitersToBushelsUk >> bushelsToQuartersUk 
        ...
        let litersToMinimsUs = litersToTeaspoons >> teaspoonsUsToMinimsUs
        let litersToHogshead = litersToBarrels >> barrelsToHogshead
        let litersToPecksUk = litersToGallonsUk >> gallonsUkToPecksUk
        let litersToBushelsUk = litersToPecksUk >> pecksUkToBushelsUk
        let litersToQuartersUk = litersToBushelsUk >> bushelsToQuartersUk
