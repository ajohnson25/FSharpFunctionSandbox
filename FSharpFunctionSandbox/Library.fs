...
module FSharpFunctionSandbox =
    ...
    module VolumeConversion =
        ...
        let pecksPerBushelUk = 4m<peck/bushel_uk>
        ...
        let pecksUkToBushelUk (gal: decimal<peck>) = gal / pecksPerBushelUk
        ...
        let millilitersToBushelUk = millilitersToPecksUk >> pecksUkToBushelUk
        let millilitersToQuartersUk = millilitersToBushelUk >> bushelsToQuartersUk 
