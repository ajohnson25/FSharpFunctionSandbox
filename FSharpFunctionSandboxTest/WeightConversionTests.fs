...
module WeightConversionTests =
    ...
    let ``Metric Ton(1000kg, approx 2204.6lb)`` () =
        ...
        Assert.Equal(22.046226218487758072297380135m<hundredweight_shrt>,metricTonsToHundredweightsShrt(1m<ton_metric>))
        Assert.Equal(19.684130552221212564551232264m<hundredweight_lng>,metricTonsToHundredweightsLng(1m<ton_metric>))
        Assert.Equal(0.9842065276110606282275616132m<ton_lng>,metricTonsToTonsLng(1m<ton_metric>))
        Assert.Equal(1.1023113109243879036148690068m<ton_shrt>,metricTonsToTonsShrt(1m<ton_metric>))
    ...
    let ``Milligrams(1/1000g) to Other`` () =
        ...
        Assert.Equal(1.0000168212706047061594091632m<ounce>,milligramsToOunces(28350m<milligram>))
        Assert.Equal(1.0000013889122517647287585547m<pound>,milligramsToPounds(453593m<milligram>))
        Assert.Equal(1.0000013889122517647287585547m<stone>,milligramsToStones(6350302m<milligram>))
    ...
    let ``Convert weight function`` () =
        ...
        Assert.Equal({WeightUnit.amount = 6.35029318m; unitName = "kilograms"},convertWeight(1m,"stones","kilograms"))
        ...
        Assert.Equal({WeightUnit.amount = 1.12m; unitName = "quartersShrt"},convertWeight(2m,"stones","quartersShrt"))
        Assert.Equal({WeightUnit.amount = 1m; unitName = "quartersLng"},convertWeight(2m,"stones","quartersLng"))
        ...
        Assert.Equal({WeightUnit.amount = 12700586.36m; unitName = "milligrams"},convertWeight(1m,"quartersLng","milligrams"))
        Assert.Equal({WeightUnit.amount = 12700.58636m; unitName = "grams"},convertWeight(1m,"quartersLng","grams"))
        Assert.Equal({WeightUnit.amount = 12.70058636m; unitName = "kilograms"},convertWeight(1m,"quartersLng","kilograms"))
        Assert.Equal({WeightUnit.amount = 0.01270058636m; unitName = "tonsMetric"},convertWeight(1m,"quartersLng","tonsMetric"))
        Assert.Equal({WeightUnit.amount = 196000m; unitName = "grains"},convertWeight(1m,"quartersLng","grains"))
        Assert.Equal({WeightUnit.amount = 7168m; unitName = "drachms"},convertWeight(1m,"quartersLng","drachms"))
        Assert.Equal({WeightUnit.amount = 448m; unitName = "ounces"},convertWeight(1m,"quartersLng","ounces"))
        Assert.Equal({WeightUnit.amount = 28m; unitName = "pounds"},convertWeight(1m,"quartersLng","pounds"))
        Assert.Equal({WeightUnit.amount = 1.12m; unitName = "quartersShrt"},convertWeight(1m,"quartersLng","quartersShrt"))
        Assert.Equal({WeightUnit.amount = 2m; unitName = "stones"},convertWeight(1m,"quartersLng","stones"))
        Assert.Equal({WeightUnit.amount = 2.24m; unitName = "hundredweightsShrt"},convertWeight(8m,"quartersLng","hundredweightsShrt"))
        Assert.Equal({WeightUnit.amount = 2m; unitName = "hundredweightsLng"},convertWeight(8m,"quartersLng","hundredweightsLng"))
        Assert.Equal({WeightUnit.amount = 2.002m; unitName = "tonsShrt"},convertWeight(143m,"quartersLng","tonsShrt"))
        Assert.Equal({WeightUnit.amount = 2m; unitName = "tonsLng"},convertWeight(160m,"quartersLng","tonsLng"))
        Assert.Equal({WeightUnit.amount = 11339809.25m; unitName = "milligrams"},convertWeight(1m,"quartersShrt","milligrams"))
        Assert.Equal({WeightUnit.amount = 11339.80925m; unitName = "grams"},convertWeight(1m,"quartersShrt","grams"))
        Assert.Equal({WeightUnit.amount = 11.33980925m; unitName = "kilograms"},convertWeight(1m,"quartersShrt","kilograms"))
        Assert.Equal({WeightUnit.amount = 0.01133980925m; unitName = "tonsMetric"},convertWeight(1m,"quartersShrt","tonsMetric"))
        Assert.Equal({WeightUnit.amount = 175000m; unitName = "grains"},convertWeight(1m,"quartersShrt","grains"))
        Assert.Equal({WeightUnit.amount = 6400m; unitName = "drachms"},convertWeight(1m,"quartersShrt","drachms"))
        Assert.Equal({WeightUnit.amount = 400m; unitName = "ounces"},convertWeight(1m,"quartersShrt","ounces"))
        Assert.Equal({WeightUnit.amount = 25m; unitName = "pounds"},convertWeight(1m,"quartersShrt","pounds"))
        Assert.Equal({WeightUnit.amount = 0.8928571428571428571428571428m; unitName = "quartersLng"},convertWeight(1m,"quartersShrt","quartersLng"))
        Assert.Equal({WeightUnit.amount = 1.7857142857142857142857142856m; unitName = "stones"},convertWeight(1m,"quartersShrt","stones"))
        Assert.Equal({WeightUnit.amount = 2m; unitName = "hundredweightsShrt"},convertWeight(8m,"quartersShrt","hundredweightsShrt"))
        Assert.Equal({WeightUnit.amount = 1.7857142857142857142857142857m; unitName = "hundredweightsLng"},convertWeight(8m,"quartersShrt","hundredweightsLng"))
        Assert.Equal({WeightUnit.amount = 1.7875m; unitName = "tonsShrt"},convertWeight(143m,"quartersShrt","tonsShrt"))
        Assert.Equal({WeightUnit.amount = 1.7857142857142857142857142857m; unitName = "tonsLng"},convertWeight(160m,"quartersShrt","tonsLng"))
        Assert.Equal({WeightUnit.amount = 45359237m; unitName = "milligrams"},convertWeight(1m,"hundredweightsShrt","milligrams"))
        Assert.Equal({WeightUnit.amount = 45359.237m; unitName = "grams"},convertWeight(1m,"hundredweightsShrt","grams"))
        Assert.Equal({WeightUnit.amount = 45.359237m; unitName = "kilograms"},convertWeight(1m,"hundredweightsShrt","kilograms"))
        Assert.Equal({WeightUnit.amount = 0.045359237m; unitName = "tonsMetric"},convertWeight(1m,"hundredweightsShrt","tonsMetric"))
        Assert.Equal({WeightUnit.amount = 700000m; unitName = "grains"},convertWeight(1m,"hundredweightsShrt","grains"))
        Assert.Equal({WeightUnit.amount = 25600m; unitName = "drachms"},convertWeight(1m,"hundredweightsShrt","drachms"))
        Assert.Equal({WeightUnit.amount = 1600m; unitName = "ounces"},convertWeight(1m,"hundredweightsShrt","ounces"))
        Assert.Equal({WeightUnit.amount = 100m; unitName = "pounds"},convertWeight(1m,"hundredweightsShrt","pounds"))
        Assert.Equal({WeightUnit.amount = 3.5714285714285714285714285716m; unitName = "quartersLng"},convertWeight(1m,"hundredweightsShrt","quartersLng"))
        Assert.Equal({WeightUnit.amount = 7.1428571428571428571428571432m; unitName = "stones"},convertWeight(1m,"hundredweightsShrt","stones"))
        Assert.Equal({WeightUnit.amount = 32m; unitName = "quartersShrt"},convertWeight(8m,"hundredweightsShrt","quartersShrt"))
        Assert.Equal({WeightUnit.amount = 7.1428571428571428571428571429m; unitName = "hundredweightsLng"},convertWeight(8m,"hundredweightsShrt","hundredweightsLng"))
        Assert.Equal({WeightUnit.amount = 7.15m; unitName = "tonsShrt"},convertWeight(143m,"hundredweightsShrt","tonsShrt"))
        Assert.Equal({WeightUnit.amount = 7.142857142857142857142857143m; unitName = "tonsLng"},convertWeight(160m,"hundredweightsShrt","tonsLng"))
        Assert.Equal({WeightUnit.amount = 50802345.44m; unitName = "milligrams"},convertWeight(1m,"hundredweightsLng","milligrams"))
        Assert.Equal({WeightUnit.amount = 50802.34544m; unitName = "grams"},convertWeight(1m,"hundredweightsLng","grams"))
        Assert.Equal({WeightUnit.amount = 50.80234544m; unitName = "kilograms"},convertWeight(1m,"hundredweightsLng","kilograms"))
        Assert.Equal({WeightUnit.amount = 0.05080234544m; unitName = "tonsMetric"},convertWeight(1m,"hundredweightsLng","tonsMetric"))
        Assert.Equal({WeightUnit.amount = 784000m; unitName = "grains"},convertWeight(1m,"hundredweightsLng","grains"))
        Assert.Equal({WeightUnit.amount = 28672m; unitName = "drachms"},convertWeight(1m,"hundredweightsLng","drachms"))
        Assert.Equal({WeightUnit.amount = 1792m; unitName = "ounces"},convertWeight(1m,"hundredweightsLng","ounces"))
        Assert.Equal({WeightUnit.amount = 112m; unitName = "pounds"},convertWeight(1m,"hundredweightsLng","pounds"))
        Assert.Equal({WeightUnit.amount = 4m; unitName = "quartersLng"},convertWeight(1m,"hundredweightsLng","quartersLng"))
        Assert.Equal({WeightUnit.amount = 8m; unitName = "stones"},convertWeight(1m,"hundredweightsLng","stones"))
        Assert.Equal({WeightUnit.amount = 35.84m; unitName = "quartersShrt"},convertWeight(8m,"hundredweightsLng","quartersShrt"))
        Assert.Equal({WeightUnit.amount = 8.96m; unitName = "hundredweightsShrt"},convertWeight(8m,"hundredweightsLng","hundredweightsShrt"))
        Assert.Equal({WeightUnit.amount = 8.008m; unitName = "tonsShrt"},convertWeight(143m,"hundredweightsLng","tonsShrt"))
        Assert.Equal({WeightUnit.amount = 8m; unitName = "tonsLng"},convertWeight(160m,"hundredweightsLng","tonsLng"))
        Assert.Equal({WeightUnit.amount = 1016046908.8m; unitName = "milligrams"},convertWeight(1m,"tonsLng","milligrams"))
        Assert.Equal({WeightUnit.amount = 1016046.9088m; unitName = "grams"},convertWeight(1m,"tonsLng","grams"))
        Assert.Equal({WeightUnit.amount = 1016.0469088m; unitName = "kilograms"},convertWeight(1m,"tonsLng","kilograms"))
        Assert.Equal({WeightUnit.amount = 1.0160469088m; unitName = "tonsMetric"},convertWeight(1m,"tonsLng","tonsMetric"))
        Assert.Equal({WeightUnit.amount = 15680000m; unitName = "grains"},convertWeight(1m,"tonsLng","grains"))
        Assert.Equal({WeightUnit.amount = 573440m; unitName = "drachms"},convertWeight(1m,"tonsLng","drachms"))
        Assert.Equal({WeightUnit.amount = 35840m; unitName = "ounces"},convertWeight(1m,"tonsLng","ounces"))
        Assert.Equal({WeightUnit.amount = 2240m; unitName = "pounds"},convertWeight(1m,"tonsLng","pounds"))
        Assert.Equal({WeightUnit.amount = 80m; unitName = "quartersLng"},convertWeight(1m,"tonsLng","quartersLng"))
        Assert.Equal({WeightUnit.amount = 160m; unitName = "stones"},convertWeight(1m,"tonsLng","stones"))
        Assert.Equal({WeightUnit.amount = 716.8m; unitName = "quartersShrt"},convertWeight(8m,"tonsLng","quartersShrt"))
        Assert.Equal({WeightUnit.amount = 179.2m; unitName = "hundredweightsShrt"},convertWeight(8m,"tonsLng","hundredweightsShrt"))
        Assert.Equal({WeightUnit.amount = 160.16m; unitName = "tonsShrt"},convertWeight(143m,"tonsLng","tonsShrt"))
        Assert.Equal({WeightUnit.amount = 3200m; unitName = "hundredweightsLng"},convertWeight(160m,"tonsLng","hundredweightsLng"))
        Assert.Equal({WeightUnit.amount = 907184740m; unitName = "milligrams"},convertWeight(1m,"tonsShrt","milligrams"))
        Assert.Equal({WeightUnit.amount = 907184.74m; unitName = "grams"},convertWeight(1m,"tonsShrt","grams"))
        Assert.Equal({WeightUnit.amount = 907.18474m; unitName = "kilograms"},convertWeight(1m,"tonsShrt","kilograms"))
        Assert.Equal({WeightUnit.amount = 0.90718474m; unitName = "tonsMetric"},convertWeight(1m,"tonsShrt","tonsMetric"))
        Assert.Equal({WeightUnit.amount = 14000000m; unitName = "grains"},convertWeight(1m,"tonsShrt","grains"))
        Assert.Equal({WeightUnit.amount = 512000m; unitName = "drachms"},convertWeight(1m,"tonsShrt","drachms"))
        Assert.Equal({WeightUnit.amount = 32000m; unitName = "ounces"},convertWeight(1m,"tonsShrt","ounces"))
        Assert.Equal({WeightUnit.amount = 2000m; unitName = "pounds"},convertWeight(1m,"tonsShrt","pounds"))
        Assert.Equal({WeightUnit.amount = 71.428571428571428571428571428m; unitName = "quartersLng"},convertWeight(1m,"tonsShrt","quartersLng"))
        Assert.Equal({WeightUnit.amount = 142.85714285714285714285714286m; unitName = "stones"},convertWeight(1m,"tonsShrt","stones"))
        Assert.Equal({WeightUnit.amount = 640m; unitName = "quartersShrt"},convertWeight(8m,"tonsShrt","quartersShrt"))
        Assert.Equal({WeightUnit.amount = 160m; unitName = "hundredweightsShrt"},convertWeight(8m,"tonsShrt","hundredweightsShrt"))
        Assert.Equal({WeightUnit.amount = 0.8928571428571428571428571428m; unitName = "tonsLng"},convertWeight(1m,"tonsShrt","tonsLng"))
        Assert.Equal({WeightUnit.amount = 17.857142857142857142857142857m; unitName = "hundredweightsLng"},convertWeight(1m,"tonsShrt","hundredweightsLng"))
        Assert.Equal({WeightUnit.amount = 1000000000m; unitName = "milligrams"},convertWeight(1m,"tonsMetric","milligrams"))
        Assert.Equal({WeightUnit.amount = 1000000m; unitName = "grams"},convertWeight(1m,"tonsMetric","grams"))
        Assert.Equal({WeightUnit.amount = 1000m; unitName = "kilograms"},convertWeight(1m,"tonsMetric","kilograms"))
        Assert.Equal({WeightUnit.amount = 1.1023113109243879036148690068m; unitName = "tonsShrt"},convertWeight(1m,"tonsMetric","tonsShrt"))
        Assert.Equal({WeightUnit.amount = 15432358.352941430650608166094m; unitName = "grains"},convertWeight(1m,"tonsMetric","grains"))
        Assert.Equal({WeightUnit.amount = 564383.39119328660665081293146m; unitName = "drachms"},convertWeight(1m,"tonsMetric","drachms"))
        Assert.Equal({WeightUnit.amount = 35273.961949580412915675808216m; unitName = "ounces"},convertWeight(1m,"tonsMetric","ounces"))
        Assert.Equal({WeightUnit.amount = 2204.6226218487758072297380135m; unitName = "pounds"},convertWeight(1m,"tonsMetric","pounds"))
        Assert.Equal({WeightUnit.amount = 78.736522208884850258204929055m; unitName = "quartersLng"},convertWeight(1m,"tonsMetric","quartersLng"))
        Assert.Equal({WeightUnit.amount = 157.47304441776970051640985811m; unitName = "stones"},convertWeight(1m,"tonsMetric","stones"))
        Assert.Equal({WeightUnit.amount = 705.47923899160825831351616432m; unitName = "quartersShrt"},convertWeight(8m,"tonsMetric","quartersShrt"))
        Assert.Equal({WeightUnit.amount = 176.36980974790206457837904108m; unitName = "hundredweightsShrt"},convertWeight(8m,"tonsMetric","hundredweightsShrt"))
        Assert.Equal({WeightUnit.amount = 0.9842065276110606282275616132m; unitName = "tonsLng"},convertWeight(1m,"tonsMetric","tonsLng"))
        Assert.Equal({WeightUnit.amount = 19.684130552221212564551232264m; unitName = "hundredweightsLng"},convertWeight(1m,"tonsMetric","hundredweightsLng"))
        Assert.Equal({WeightUnit.amount = 1m; unitName = "tonsMetric"},convertWeight(1000000000m,"milligrams","tonsMetric"))
        Assert.Equal({WeightUnit.amount = 1m; unitName = "grams"},convertWeight(1000m,"milligrams","grams"))
        Assert.Equal({WeightUnit.amount = 1m; unitName = "kilograms"},convertWeight(1000000m,"milligrams","kilograms"))
        Assert.Equal({WeightUnit.amount = 1.1023113109243879036148690068m; unitName = "tonsShrt"},convertWeight(1000000000m,"milligrams","tonsShrt"))
        Assert.Equal({WeightUnit.amount = 1.54323583529414306506081660m; unitName = "grains"},convertWeight(100m,"milligrams","grains"))
        Assert.Equal({WeightUnit.amount = 5.6438339119328660665081293056m; unitName = "drachms"},convertWeight(10000m,"milligrams","drachms"))
        Assert.Equal({WeightUnit.amount = 3.5273961949580412915675808208m; unitName = "ounces"},convertWeight(100000m,"milligrams","ounces"))
        Assert.Equal({WeightUnit.amount = 2.2046226218487758072297380135m; unitName = "pounds"},convertWeight(1000000m,"milligrams","pounds"))
        Assert.Equal({WeightUnit.amount = 7.8736522208884850258204929055m; unitName = "quartersLng"},convertWeight(100000000m,"milligrams","quartersLng"))
        Assert.Equal({WeightUnit.amount = 157.47304441776970051640985811m; unitName = "stones"},convertWeight(1000000000m,"milligrams","stones"))
        Assert.Equal({WeightUnit.amount = 7.0547923899160825831351616432m; unitName = "quartersShrt"},convertWeight(80000000m,"milligrams","quartersShrt"))
        Assert.Equal({WeightUnit.amount = 1.7636980974790206457837904108m; unitName = "hundredweightsShrt"},convertWeight(80000000m,"milligrams","hundredweightsShrt"))
        Assert.Equal({WeightUnit.amount = 9.842065276110606282275616132m; unitName = "tonsLng"},convertWeight(10000000000m,"milligrams","tonsLng"))
        Assert.Equal({WeightUnit.amount = 1.9684130552221212564551232264m; unitName = "hundredweightsLng"},convertWeight(100000000m,"milligrams","hundredweightsLng"))
        Assert.Equal({WeightUnit.amount = 1m; unitName = "tonsMetric"},convertWeight(1000000m,"grams","tonsMetric"))
        Assert.Equal({WeightUnit.amount = 1000m; unitName = "milligrams"},convertWeight(1m,"grams","milligrams"))
        Assert.Equal({WeightUnit.amount = 1m; unitName = "kilograms"},convertWeight(1000m,"grams","kilograms"))
        Assert.Equal({WeightUnit.amount = 1.1023113109243879036148690068m; unitName = "tonsShrt"},convertWeight(1000000m,"grams","tonsShrt"))
        Assert.Equal({WeightUnit.amount = 15.432358352941430650608166m; unitName = "grains"},convertWeight(1m,"grams","grains"))
        Assert.Equal({WeightUnit.amount = 5.6438339119328660665081293056m; unitName = "drachms"},convertWeight(10m,"grams","drachms"))
        Assert.Equal({WeightUnit.amount = 3.5273961949580412915675808208m; unitName = "ounces"},convertWeight(100m,"grams","ounces"))
        Assert.Equal({WeightUnit.amount = 2.2046226218487758072297380135m; unitName = "pounds"},convertWeight(1000m,"grams","pounds"))
        Assert.Equal({WeightUnit.amount = 7.8736522208884850258204929055m; unitName = "quartersLng"},convertWeight(100000m,"grams","quartersLng"))
        Assert.Equal({WeightUnit.amount = 157.47304441776970051640985811m; unitName = "stones"},convertWeight(1000000m,"grams","stones"))
        Assert.Equal({WeightUnit.amount = 7.0547923899160825831351616432m; unitName = "quartersShrt"},convertWeight(80000m,"grams","quartersShrt"))
        Assert.Equal({WeightUnit.amount = 1.7636980974790206457837904108m; unitName = "hundredweightsShrt"},convertWeight(80000m,"grams","hundredweightsShrt"))
        Assert.Equal({WeightUnit.amount = 9.842065276110606282275616132m; unitName = "tonsLng"},convertWeight(10000000m,"grams","tonsLng"))
        Assert.Equal({WeightUnit.amount = 1.9684130552221212564551232264m; unitName = "hundredweightsLng"},convertWeight(100000m,"grams","hundredweightsLng"))
        Assert.Equal({WeightUnit.amount = 1m; unitName = "tonsMetric"},convertWeight(1000m,"kilograms","tonsMetric"))
        Assert.Equal({WeightUnit.amount = 1000000m; unitName = "milligrams"},convertWeight(1m,"kilograms","milligrams"))
        Assert.Equal({WeightUnit.amount = 1000m; unitName = "grams"},convertWeight(1m,"kilograms","grams"))
        Assert.Equal({WeightUnit.amount = 1.1023113109243879036148690068m; unitName = "tonsShrt"},convertWeight(1000m,"kilograms","tonsShrt"))
        Assert.Equal({WeightUnit.amount = 15432.358352941430650608166094m; unitName = "grains"},convertWeight(1m,"kilograms","grains"))
        Assert.Equal({WeightUnit.amount = 564.38339119328660665081293146m; unitName = "drachms"},convertWeight(1m,"kilograms","drachms"))
        Assert.Equal({WeightUnit.amount = 35.273961949580412915675808216m; unitName = "ounces"},convertWeight(1m,"kilograms","ounces"))
        Assert.Equal({WeightUnit.amount = 2.2046226218487758072297380135m; unitName = "pounds"},convertWeight(1m,"kilograms","pounds"))
        Assert.Equal({WeightUnit.amount = 7.8736522208884850258204929055m; unitName = "quartersLng"},convertWeight(100m,"kilograms","quartersLng"))
        Assert.Equal({WeightUnit.amount = 157.47304441776970051640985811m; unitName = "stones"},convertWeight(1000m,"kilograms","stones"))
        Assert.Equal({WeightUnit.amount = 7.0547923899160825831351616432m; unitName = "quartersShrt"},convertWeight(80m,"kilograms","quartersShrt"))
        Assert.Equal({WeightUnit.amount = 1.7636980974790206457837904108m; unitName = "hundredweightsShrt"},convertWeight(80m,"kilograms","hundredweightsShrt"))
        Assert.Equal({WeightUnit.amount = 9.842065276110606282275616132m; unitName = "tonsLng"},convertWeight(10000m,"kilograms","tonsLng"))
        Assert.Equal({WeightUnit.amount = 1.9684130552221212564551232264m; unitName = "hundredweightsLng"},convertWeight(100m,"kilograms","hundredweightsLng"))