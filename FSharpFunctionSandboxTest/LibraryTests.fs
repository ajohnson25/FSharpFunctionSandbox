...
module WeightConversion =
    ...
    let ``Convert weight function`` () =
        ...
        Assert.Equal({WeightUnit.amount = 453592.37000000m; unitName = "milligrams"},convertWeight(1m,"pounds","milligrams"))
        Assert.Equal({WeightUnit.amount = 453.59237000m; unitName = "grams"},convertWeight(1m,"pounds","grams"))
        Assert.Equal({WeightUnit.amount = 0.45359237m; unitName = "kilograms"},convertWeight(1m,"pounds","kilograms"))
        Assert.Equal({WeightUnit.amount = 0.999989738902m; unitName = "tonsMetric"},convertWeight(2204.6m,"pounds","tonsMetric"))
        Assert.Equal({WeightUnit.amount = 7000m; unitName = "grains"},convertWeight(1m,"pounds","grains"))
        Assert.Equal({WeightUnit.amount = 256m; unitName = "drachms"},convertWeight(1m,"pounds","drachms"))
        Assert.Equal({WeightUnit.amount = 16m; unitName = "ounces"},convertWeight(1m,"pounds","ounces"))
        Assert.Equal({WeightUnit.amount = 1m; unitName = "stones"},convertWeight(14m,"pounds","stones"))
        Assert.Equal({WeightUnit.amount = 1m; unitName = "quartersShrt"},convertWeight(25m,"pounds","quartersShrt"))
        Assert.Equal({WeightUnit.amount = 1m; unitName = "quartersLng"},convertWeight(28m,"pounds","quartersLng"))
        Assert.Equal({WeightUnit.amount = 1m; unitName = "hundredweightsShrt"},convertWeight(100m,"pounds","hundredweightsShrt"))
        Assert.Equal({WeightUnit.amount = 1m; unitName = "hundredweightsLng"},convertWeight(112m,"pounds","hundredweightsLng"))
        Assert.Equal({WeightUnit.amount = 1m; unitName = "tonsShrt"},convertWeight(2000m,"pounds","tonsShrt"))
        Assert.Equal({WeightUnit.amount = 1m; unitName = "tonsLng"},convertWeight(2240m,"pounds","tonsLng"))
        Assert.Equal({WeightUnit.amount = 6350293.18m; unitName = "milligrams"},convertWeight(1m,"stones","milligrams"))
        Assert.Equal({WeightUnit.amount = 6350.29318m; unitName = "grams"},convertWeight(1m,"stones","grams"))
        Assert.Equal({WeightUnit.amount = 6.35029318m; unitName = "kilograms"},convertWeight(1m,"stones","grams"))
        Assert.Equal({WeightUnit.amount = 1.0000000036973331m; unitName = "tonsMetric"},convertWeight(157.473045m,"stones","tonsMetric"))
        Assert.Equal({WeightUnit.amount = 98000m; unitName = "grains"},convertWeight(1m,"stones","grains"))
        Assert.Equal({WeightUnit.amount = 3584m; unitName = "drachms"},convertWeight(1m,"stones","drachms"))
        Assert.Equal({WeightUnit.amount = 224m; unitName = "ounces"},convertWeight(1m,"stones","ounces"))
        Assert.Equal({WeightUnit.amount = 14m; unitName = "pounds"},convertWeight(1m,"stones","pounds"))
        Assert.Equal({WeightUnit.amount = 1.12m; unitName = "quartersShrt"},convertWeight(2m,"stones","pounds"))
        Assert.Equal({WeightUnit.amount = 1m; unitName = "quartersLng"},convertWeight(2m,"stones","pounds"))
        Assert.Equal({WeightUnit.amount = 1.12m; unitName = "hundredweightsShrt"},convertWeight(8m,"stones","hundredweightsShrt"))
        Assert.Equal({WeightUnit.amount = 1m; unitName = "hundredweightsLng"},convertWeight(8m,"stones","hundredweightsLng"))
        Assert.Equal({WeightUnit.amount = 1.001m; unitName = "tonsShrt"},convertWeight(143m,"stones","tonsShrt"))
        Assert.Equal({WeightUnit.amount = 1m; unitName = "tonsLng"},convertWeight(160m,"stones","tonsLng"))